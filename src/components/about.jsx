  ...
  return (
    <div className='w-full p-20 bg-[#cdea68] rounded-tl-3xl rounded-tr-3xl'>
        ...
        <div className='w-full flex mt-[6vw] items-center gap-[5vw] border-b-[1px] border-black pb-[3vw] '>
         <div className='flex w-[70vw]  gap-[35vw]'>
         <h1 className=' w-[10vw] text-[20px] text-black'>What you can expect:</h1>
          <h1 className=' w-[15vw] text-[20px] text-black'>
          ...
          <div className='flex text-[20px] flex-col text-black '>
            <a href="">Instgram</a>
            <a href="">Behence</a>
            <a href="">Facebook</a>
            <a href="">LinkedIn</a>
        ...
        <div className='w-full flex justify-between '>
          <div className='mt-[2vw]'>
            <h1 className='text-black text-[80px] font-bold' style={{letterSpacing:"-0.07em" , wordSpacing:"0.1em"}}>Our approch:</h1>
            <button className='bg-black rounded-full w-[10vw] h-10'>READ MORE </button>
          </div>
